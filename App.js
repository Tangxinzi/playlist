...
const ICON_THUMB_1 = new Icon(require("./assets/images/thumb_1.png"), 12, 12);
const ICON_THUMB_2 = new Icon(require("./assets/images/thumb_2.png"), 12, 12);
...
const FONT_SIZE = 16;
const LOADING_STRING = "加载中 ...";
const BUFFERING_STRING = "缓冲中 ...";
...
export default class App extends React.Component {
  ...
  _onReadyForDisplay = event => {
    ...
    if (widestHeight > VIDEO_CONTAINER_HEIGHT) {
      this.setState({
        videoWidth: (VIDEO_CONTAINER_HEIGHT * event.naturalSize.width) /
  ...
  render() {
    return !this.state.fontLoaded ? (
      ...
      <View style={{...styles.container, height: DEVICE_HEIGHT, paddingBottom: 50}}>
        ...
        >
          ...
          <View style={styles.timestampRow}>
            <Text style={styles.text, styles.timestamp}>{this.state.isBuffering ? BUFFERING_STRING : ""}</Text>
